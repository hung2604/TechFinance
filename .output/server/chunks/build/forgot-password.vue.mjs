      ...
      _push(ssrRenderComponent(_component_UButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(" Gửi yêu cầu ")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<div class="text-center text-sm text-gray-600 dark:text-gray-400"> Đã nhớ mật khẩu? `);
