import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef as toRef$1, inject, ref, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, unref, onScopeDispose, toRefs, toValue, readonly, customRef, nextTick, defineComponent, onServerPrefetch, h, mergeProps, useSSRContext, useAttrs, provide, watch, withCtx, createVNode, resolveDynamicComponent, createBlock, renderSlot, openBlock, toDisplayString, resolveComponent, useSlots, createCommentVNode, Fragment, createTextVNode, withModifiers, renderList, markRaw, useId, Suspense, onErrorCaptured, createApp } from 'vue';
import { k as createHooks, l as getContext, c as createError$1, t as toRouteMatcher, m as createRouter, n as defu, o as hasProtocol, q as joinURL, w as withQuery, v as sanitizeStatusCode, x as isScriptProtocol, y as executeAsync, z as destr, A as klona, B as parse, C as getRequestHeader, D as isEqual, s as setCookie, E as getCookie, F as deleteCookie, G as defuFn, H as serialize, I as withLeadingSlash, J as parseURL, K as encodePath, L as encodeParam, M as parseQuery, N as withTrailingSlash, O as withoutTrailingSlash } from '../nitro/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    name: "kickstarter",
    path: "/kickstarter",
    component: () => import('./kickstarter.vue.mjs')
  },
  {
    name: "users",
    path: "/users",
  ...
  },
  {
    ...
    component: () => import('./reset-password.vue.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./purchase-packages.vue.mjs')
  },
  {
    name: "coin-history",
    path: "/coin-history",
...
const __nuxt_component_0$2 = Object.assign(_sfc_main$c, { __name: "UIcon" });
          ...
          if (_push2) {
            if (_ctx.src && !error.value) {
              ...
              ssrRenderSlot(_ctx.$slots, "default", {}, () => {
                var _a4, _b2;
                if (_ctx.icon) {
                  _push2(ssrRenderComponent(__nuxt_component_0$2, {
                    name: _ctx.icon,
            ...
            return [
              _ctx.src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(ImageComponent)), mergeProps({
                ...
                var _a4, _b2;
                return [
                  _ctx.icon ? (openBlock(), createBlock(__nuxt_component_0$2, {
                    key: 0,
                    name: _ctx.icon,
                    class: ui.value.icon({ class: (_a4 = props.ui) == null ? void 0 : _a4.icon })
...
const __nuxt_component_4 = Object.assign(_sfc_main$a, { __name: "UAvatar" });
                ...
                if (_push3) {
                  ssrRenderSlot(_ctx.$slots, "leading", {}, () => {
                    ...
                    if (unref(isLeading) && unref(leadingIconName)) {
                      _push3(ssrRenderComponent(__nuxt_component_0$2, {
                  ...
                  return [
                    renderSlot(_ctx.$slots, "leading", {}, () => {
                      var _a4, _b2, _c;
                      return [
                        unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(__nuxt_component_0$2, {
                          key: 0,
                          name: unref(leadingIconName),
                          class: ui.value.leadingIcon({ class: (_a4 = props.ui) == null ? void 0 : _a4.leadingIcon, active })
                    ...
                    renderSlot(_ctx.$slots, "trailing", {}, () => {
                      var _a4;
                      return [
                        unref(isTrailing) && unref(trailingIconName) ? (openBlock(), createBlock(__nuxt_component_0$2, {
                          key: 0,
                          name: unref(trailingIconName),
                          class: ui.value.trailingIcon({ class: (_a4 = props.ui) == null ? void 0 : _a4.trailingIcon, active })
          ...
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "leading", {}, () => {
                var _a4, _b2, _c2;
                return [
                  _ctx.avatar ? (openBlock(), createBlock(__nuxt_component_4, mergeProps({
                    key: 0,
                    size: ((_a4 = props.ui) == null ? void 0 : _a4.avatarSize) || ui.value.avatarSize()
                  }, _ctx.avatar, {
                    class: ui.value.avatar({ class: (_b2 = props.ui) == null ? void 0 : _b2.avatar })
                  }), null, 16, ["size", "class"])) : _ctx.icon ? (openBlock(), createBlock(__nuxt_component_0$2, {
                    key: 1,
                    name: _ctx.icon,
                    class: ui.value.icon({ class: (_c2 = props.ui) == null ? void 0 : _c2.icon })
                  }, null, 8, ["name", "class"])) : createCommentVNode("", true)
...
export { camelize as A, createSharedComposable as B, omit as C, pickLinkProps as D, ULinkBase as E, useState as F, useCookie as G, navigateTo as H, ImageComponent as I, server as J, ULink as U, _export_sfc as _, __nuxt_component_0$1 as a, __nuxt_component_2$1 as b, __nuxt_component_0$2 as c, _appConfig as d, useAvatarGroup as e, useAppConfig as f, reactivePick as g, useFormField as h, useButtonGroup as i, useComponentIcons as j, __nuxt_component_4 as k, get as l, compare as m, fetchDefaults as n, useAsyncData as o, useRequestFetch as p, useToast as q, refreshNuxtData as r, looseToNumber as s, tv as t, useHead as u, useLocale as v, reactiveOmit as w, useRoute as x, useRuntimeConfig as y, makeDestructurable as z };
